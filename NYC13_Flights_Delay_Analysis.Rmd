...
In this analysis, I applied regression models to investigate the factors affecting flight delays.

**Methods used:** I performed simple linear regression to explore the relationship between flight delay metrics and individual predictors such as month or time slot. Subsequently, a multiple linear regression model was constructed to examine the combined effect of both month and time slot on delay outcomes.

**Purpose of models:** The simple regression models help identify how each factor independently influences delays, while the multiple regression model captures the joint impact of these factors, allowing for control of confounding effects.
