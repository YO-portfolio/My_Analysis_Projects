...
The "hotel room" category has only 4 listings in the dataset, and the average price shown here may not be representative.

#### **Brief Interpretation:**

Entire homes/apartments averaged £126.7, reflecting their size and capacity. While hotel rooms (£79.8) were about 1.6 times more expensive than private rooms (£49.9), this is likely due to the very small number of observations (n = 4), and may not reflect the actual market trend.
<br><br>
...
-   Visualizations revealed clear pricing trends across location and room type categories. For instance, areas like Hotwells & Harbourside exhibited significantly higher average prices, and entire homes/apartments were priced higher than other room types. It should be noted, however, that the "hotel room" category contained only a few listings, making its average price potentially unreliable.
...
-   The "hotel room" category included only four listings, which limited the reliability of any conclusions drawn about this room type.
